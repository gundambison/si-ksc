...
/*
	...
	access	: Clinic/ksc/rawatinapact
	
	list field tersedia : 
			  %fields% 
	id 		: %field_id%
*/
class Controllers_Clinic_Ksc_Rawatinapact extends Modules_Plugin_Base {
...
//		$this->logger->write('debug', 'HTTP REQUEST: '.print_r($_REQUEST,1));
		$this->model = $this->_loadModel('rawatinapact_model'); //base
...
*/
		$rawatinapact=$this->model->getAll();
		$result['show']=count($rawatinapact);
		$result['rawatinapact']=$rawatinapact;
