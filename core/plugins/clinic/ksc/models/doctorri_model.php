<?php
class Models_Clinic_Ksc_Doctorri_model extends Base_Model {
var $table='klinik_docri'; //main table
/*
	Detail Doctorri berdasarkan id
*/
...
*/
	public function __construct(){
		...
		$this->logger->write('info', 'model: Doctorri');
	}
