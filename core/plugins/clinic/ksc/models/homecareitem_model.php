<?php
class Models_Clinic_Ksc_Homecareitem_model extends Base_Model {
var $table='hc_item'; //main table
/*
	Detail Homecareitem berdasarkan id
*/
...
*/
	public function __construct(){
		...
		$this->logger->write('info', 'model: Homecareitem');
	}
