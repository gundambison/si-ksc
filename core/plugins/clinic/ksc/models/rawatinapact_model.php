<?php
class Models_Clinic_Ksc_Rawatinapact_model extends Base_Model {
var $table='klinik_ri-doc'; //main table
/*
	Detail Rawatinapact berdasarkan id
*/
...
*/
	public function __construct(){
		...
		$this->logger->write('info', 'model: Rawatinapact');
	}
